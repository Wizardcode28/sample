...
const Faqs = () => {
  ...
  return (
    <div className='faqscontainer' id="faqs">
      ...
      <div className="faqs">
        <div className="faq">
            <div className="question" onClick={()=>{handleClick(0)}} data-aos="fade-right"  data-aos-delay="0" data-aos-offset="300">
              Who are we?
        ...
        <div className="faq">
            <div className="question" onClick={()=>{handleClick(1)}} data-aos="fade-left"  data-aos-delay="150" data-aos-offset="300">
        ...
        <div className="faq">
            <div className="question" onClick={()=>{handleClick(2)}} data-aos="fade-right"  data-aos-delay="300" data-aos-offset="300">
        ...
        <div className="faq">
            <div className="question" onClick={()=>{handleClick(3)}} data-aos="fade-left" data-aos-delay="450" data-aos-offset="300">
        ...
        <div className="faq">
            <div className="question" onClick={()=>{handleClick(4)}} data-aos="fade-right" data-aos-delay="300" data-aos-offset="300">
        ...
        <div className="faq">
            <div className="question" onClick={()=>{handleClick(5)}} data-aos="fade-left" data-aos-delay="750" data-aos-offset="300">
        ...
        <div className="faq">
            <div className="question" onClick={()=>{handleClick(6)}} data-aos="fade-right" data-aos-delay="900" data-aos-offset="300">
        ...
        <div className="faq">
            <div className="question" onClick={()=>{handleClick(7)}} data-aos="fade-left" data-aos-delay="1050" data-aos-offset="300">
        ...
        <div className="faq">
            <div className="question" onClick={()=>{handleClick(8)}} data-aos="fade-right" data-aos-delay="1300" data-aos-offset="300">
              How to participate?
        ...
        <div className="faq">
            <div className="question" onClick={()=>{handleClick(9)}} data-aos="fade-left" data-aos-delay="1350" data-aos-offset="300">
        ...
        <div className="faq">
            <div className="question" onClick={()=>{handleClick(10)}} data-aos="fade-right" data-aos-delay="1500" data-aos-offset="300">
